...
public class BonkExpressionCallImpl extends ASTWrapperPsiElement implements BonkExpressionCall {

  public BonkExpressionCallImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public BonkParameterList getParameterList() {
    return findChildByClass(BonkParameterList.class);
  }
