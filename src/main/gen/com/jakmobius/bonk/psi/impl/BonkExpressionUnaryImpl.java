...
public class BonkExpressionUnaryImpl extends ASTWrapperPsiElement implements BonkExpressionUnary {

  public BonkExpressionUnaryImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public BonkUnaryOperator getUnaryOperator() {
    return findNotNullChildByClass(BonkUnaryOperator.class);
  }
