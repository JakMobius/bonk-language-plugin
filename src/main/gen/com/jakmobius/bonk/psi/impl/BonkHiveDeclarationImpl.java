...
public class BonkHiveDeclarationImpl extends ASTWrapperPsiElement implements BonkHiveDeclaration {

  public BonkHiveDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BonkVisitor visitor) {
    visitor.visitHiveDeclaration(this);
  }
  ...
  @Override
  @NotNull
  public BonkHiveBody getHiveBody() {
    return findNotNullChildByClass(BonkHiveBody.class);
  }
