...
public class BonkVariableDeclarationImpl extends ASTWrapperPsiElement implements BonkVariableDeclaration {

  public BonkVariableDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
