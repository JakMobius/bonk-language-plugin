...
public class BonkAssignmentOperatorImpl extends ASTWrapperPsiElement implements BonkAssignmentOperator {

  public BonkAssignmentOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
