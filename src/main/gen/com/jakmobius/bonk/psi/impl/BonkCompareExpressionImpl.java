...
public class BonkCompareExpressionImpl extends BonkExpressionImpl implements BonkCompareExpression {

  public BonkCompareExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
