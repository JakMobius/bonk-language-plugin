...
public class BonkEqComparisonOperatorImpl extends ASTWrapperPsiElement implements BonkEqComparisonOperator {

  public BonkEqComparisonOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BonkVisitor visitor) {
    visitor.visitEqComparisonOperator(this);
  }
