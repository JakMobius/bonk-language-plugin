...
public class BonkBonkStatementImpl extends BonkStatementImpl implements BonkBonkStatement {

  public BonkBonkStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull BonkVisitor visitor) {
    visitor.visitBonkStatement(this);
  }
