...
public class BonkBrekStatementImpl extends BonkStatementImpl implements BonkBrekStatement {

  public BonkBrekStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull BonkVisitor visitor) {
    visitor.visitBrekStatement(this);
  }
