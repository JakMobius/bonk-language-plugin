...
public class BonkWrapperStatementImpl extends BonkStatementImpl implements BonkWrapperStatement {

  public BonkWrapperStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull BonkVisitor visitor) {
    visitor.visitWrapperStatement(this);
  }
