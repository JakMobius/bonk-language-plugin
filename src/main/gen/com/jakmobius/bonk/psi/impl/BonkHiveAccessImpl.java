...
public class BonkHiveAccessImpl extends ASTWrapperPsiElement implements BonkHiveAccess {

  public BonkHiveAccessImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BonkVisitor visitor) {
    visitor.visitHiveAccess(this);
  }
