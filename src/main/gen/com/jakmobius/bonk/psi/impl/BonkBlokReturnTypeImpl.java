...
public class BonkBlokReturnTypeImpl extends ASTWrapperPsiElement implements BonkBlokReturnType {

  public BonkBlokReturnTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BonkVisitor visitor) {
    visitor.visitBlokReturnType(this);
  }
  ...
  public BonkType getType() {
    return findNotNullChildByClass(BonkType.class);
  }
