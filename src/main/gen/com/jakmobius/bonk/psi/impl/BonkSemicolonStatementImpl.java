...
public class BonkSemicolonStatementImpl extends BonkStatementImpl implements BonkSemicolonStatement {

  public BonkSemicolonStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull BonkVisitor visitor) {
    visitor.visitSemicolonStatement(this);
  }
  ...
  public BonkStatement getStatement() {
    return findNotNullChildByClass(BonkStatement.class);
  }
