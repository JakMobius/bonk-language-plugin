...
public class BonkTrivialTypeImpl extends ASTWrapperPsiElement implements BonkTrivialType {

  public BonkTrivialTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BonkVisitor visitor) {
    visitor.visitTrivialType(this);
  }
